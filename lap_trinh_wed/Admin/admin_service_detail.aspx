...
<head runat="server">
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
        ...
        .note-text { font-size: 16px; color: #666; margin-bottom: 40px; line-height: 1.5; }

        /* Footer: 2 nút Chỉnh sửa & Đóng như yêu cầu */
        .footer-actions { display: flex; gap: 20px; }
        .btn {
            flex: 1; padding: 15px; border-radius: 20px; border: 1px solid #999;
